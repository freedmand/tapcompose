...
import SliderInterface from '../interface/slider.html';
...
const slider = new SliderInterface({
...
const score = new TapComposeScore(scoreRenderer, scheduler, polyInstrument,
    suggester, westernChordDictionary,
    'C2maj7,F2m7-E4,0,1|E4,1,2|G3,2,3|G3,3,4|A4,3,4|Ab4,4,4.5|Ab4,4.5,5|G3,5,7|A4,7,8');
